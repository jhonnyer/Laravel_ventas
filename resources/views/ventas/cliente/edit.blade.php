...
@section('contenido')
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <h3>Editar Cliente:   <strong>{{$persona->nombre}}</strong></h3>
            @if(count($errors)>0)
            ...
            {!!Form::model($persona,['method'=>'PATCH','action'=>['App\Http\Controllers\ClienteController@update',$persona->idpersona]])!!}
            {{Form::token()}}            
    <div class="row">
